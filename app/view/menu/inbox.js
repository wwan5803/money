          ...
          <View style={{ flex:1 }}>
            <View style={{ flex:1, flexDirection:'row', padding: 15 }}>
              ...
              <View style={{ flex:1, paddingHorizontal:5 }}>
                ...
                <View style={{ flex:1 }}>
                  <Text style={{ fontFamily:Constant.font.roman, fontSize:10 }} numberOfLines={3}>
                    { rowData.descript }
                  </Text>
                </View>
              </View>
        ...
        <View style={styles.container}>
          <View style={ styles.titleBar }>
            <View style={{ flex:1, flexDirection:'row', alignItems:'center', justifyContent:'center' }}>
              ...
              <Text style={{ flex:1, color:'white', fontSize:15, fontFamily:Constant.font.roman, textAlign:'center', paddingTop:3 }}>
                Inbox
              </Text>
